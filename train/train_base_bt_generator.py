    ...
    with torch.no_grad():
        for i in range(len(test_dataset)):
            ...
            for i, remain_grid_id in enumerate(remain_grid_id_list):
                ...
                np.savetxt('../pic/input_txt' + str(i) + '.txt', remain_grid_list[i], fmt="%f;%f;%f")
                np.savetxt('../pic/output_txt' + str(i) + '.txt', pts, fmt="%f;%f;%f")
                np.savetxt('../pic/input_points_txt' + str(i) + '.txt', pointss, fmt="%f;%f;%f")
